...
jlink --module-path $JAVA_HOME/jmods:build/mods --add-modules org.lwjgl.vulkan.natives --add-modules spck.game --launcher APP=spck.game/spck.game.Main --compress 2 --no-header-files --no-man-pages --strip-debug --output build/release
